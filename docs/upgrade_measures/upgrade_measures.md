...
{: .fw-500 }
See the table, below, for a complete list of available energy efficiency and electrification measures and packages in ComStock datasets, including a link to their documentation, and in which dataset release the measure was first included. All measures have been developed through the End Use Savings Shapes project.
...
Release webinar recordings and slides can be found at the bottom of the page.

<!-- The table below summarizes available ComStock upgrade measures and packages, including a link to their documentation, and in which dataset release the measure was first included. Note that each new dataset release includes all existing measures from the previous releases. -->
...
*Measures are included in the initial release and all subsequent releases
