...
Release webinar recordings and slides can be found at the [bottom of the page](https://nrel.github.io/ComStock.github.io/docs/upgrade_measures/upgrade_measures.html#release-webinar-recordings-and-slides).
...
*Measures are included in the initial dataset release and all subsequent releases
