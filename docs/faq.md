...
<ul class="jk_accordion">
  ...
  <li class="acc"><input id="accordion4" type="checkbox" /><label for="accordion4">Is ComStock credible?</label>
    <div class="show">
...
<ul class="jk_accordion">
  ...
  <li class="acc"><input id="accordion30" type="checkbox" /><label for="accordion30">How should I cite the dataset?</label>
    <div class="show">
