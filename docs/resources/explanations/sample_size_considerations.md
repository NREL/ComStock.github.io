...
There are other important considerations when conducting analysis using ComStock datasets not covered in this explanation, including modeling methods and assumptions, and calibration. See the [ComStock reference documentation]({{site.baseurl}}{% link docs/resources/resources.md %}#references) for information.
...
For more detail, please see the [ComStock reference documentation]({{site.baseurl}}{% link docs/resources/resources.md %}#references).
